  ...
  return (
    <div className="min-w-[9rem]">
      <div className="mb-1 flex items-center justify-between gap-2 text-[11px] text-base-muted">
        <span>
          {formatDurationMinutes(plannedMinutes)} planificadas de {formatDurationMinutes(capacityMinutes)}
        </span>
        {over ? <span className="font-semibold text-priority-high">Sobreplanificado</span> : null}
      </div>
